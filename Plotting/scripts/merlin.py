...
"""This is the main plotting program
	...
	It handles only the options, the main functionality is in python/merlincore.py
"""
...
import Artus.Plotting.merlincore as merlincore
import Artus.Plotting.tools.plotrc as plotrc
