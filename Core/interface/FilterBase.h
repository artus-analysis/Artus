...
public:
	...
	{
		ARTUS_LOG_FATAL("DoesEventPassGlobal for filter " << this->GetFilterId() << " is not implemented");
		return false;
	}
	...
	{
		ARTUS_LOG_FATAL("DoesEventPassLocal for filter " << this->GetFilterId() << " is not implemented");
		return false;
	}
