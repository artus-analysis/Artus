...
\begin{itemize}
 \item High performance to cope with massive data amounts % -> C++, pipelines, only necessary producers
 \item Usable for different physics analyses % -> modular structure, producers
 ...
 \item Easy to install, use and understand; also for programming newcomers % test analysis, tutorial, documentation(TODO)
 \item Possibility to include libraries and existing HEP code % -> C++ used
