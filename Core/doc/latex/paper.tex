...
\todo[inline]{Didn't we agree to remove the following sentence?} The first important step is to always have an updated recipe that works out of the box on each machine offering CVMFS.
