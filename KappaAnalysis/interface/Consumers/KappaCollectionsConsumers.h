...
public:
	KappaElectronsConsumer(std::string treeName = "electrons",
	                       ...
	                       std::map<KDataElectron*, KGenParticle*> product_type::*genParticleMatchedObjects = &product_type::m_genParticleMatchedElectrons);
...
public:
	KappaMuonsConsumer(std::string treeName = "muons",
	                   ...
	                   std::map<KDataMuon*, KGenParticle*> product_type::*genParticleMatchedObjects = &product_type::m_genParticleMatchedMuons);
...
public:
	KappaTausConsumer(std::string treeName = "taus",
	                  ...
	                  std::map<KDataPFTau*, KGenParticle*> product_type::*genParticleMatchedObjects = &product_type::m_genParticleMatchedTaus,
...
public:
	KappaJetsConsumer(std::string treeName = "jets",
	                  ...
	                  std::map<KDataPFJet*, KGenParticle*> product_type::*genParticleMatchedObjects = &product_type::m_genParticleMatchedJets);
