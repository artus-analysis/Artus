...
public:
		...
		ARTUS_CPP11_OVERRIDE
	{
		...
		else if(id == ElectronGenMatchingProducer<TTypes>().GetProducerId())
			return new ElectronGenMatchingProducer<TTypes>();
		else if(id == MuonGenMatchingProducer<TTypes>().GetProducerId())
